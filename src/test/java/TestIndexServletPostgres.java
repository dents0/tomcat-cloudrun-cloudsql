...
import org.gcpshowcase.cloudrun.IndexServlet;
import org.gcpshowcase.cloudrun.IndexServlet.TemplateData;
...
public class TestIndexServletPostgres {
    ...
    private static final List<String> requiredEnvVars =
    ...
    public static void createPool() throws SQLException {
        ...
        config.setPassword(System.getenv("PG_PASS"));
